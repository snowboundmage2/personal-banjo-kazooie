...
#define SPRITE_TYPE_CI4 (1u << 0) //0x001
#define SPRITE_TYPE_CI8 (1u << 2) //0x004
#define SPRITE_TYPE_I4 (1u << 5)  //0x020
#define SPRITE_TYPE_I8 (1u << 6)  //0x040
#define SPRITE_TYPE_IA4 (1u << 7) //0x080
#define SPRITE_TYPE_IA8 (1u << 8) //0x100
#define SPRITE_TYPE_UNKNOWN_200 (1u << 9) //0x200
#define SPRITE_TYPE_RGBA16 (1u << 10) //0x400
#define SPRITE_TYPE_RGBA32 (1u << 11) //0x800
...
/*HERE*/
    ...
    ASSET_B3E_DIALOG_CONGA_MEET_AS_TERMITE  = 0xb3e,
    ...
    ASSET_DB3_DIALOG_SNS_EGG_1_TEXT = 0xdb3,
    ...
    ASSET_E57_DIALOG_FIRST_JIGGY = 0xF57,
